...
| Председатель | `admin` | Полный доступ к своей организации |
| Казначей | `treasurer` | Финансовые операции своей организации |
| Член правления | `board` | Просмотр данных своей организации |
| Член кооператива | `member` | Ограниченный просмотр |
